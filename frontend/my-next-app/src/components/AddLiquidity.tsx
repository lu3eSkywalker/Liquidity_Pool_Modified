  ...
  async function addLiquidity() {
    if (window.ethereum) {
      try {
        ...
        const ethToWeiA = ethers.parseUnits(tokenAQuantity, 18);
        const ethToWeiB = ethers.parseUnits(tokenBQuantity, 18);

        const sendTokens = await contract.addLiquidity(ethToWeiA, ethToWeiB);
